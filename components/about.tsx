...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-gray-100/50 dark:bg-black/40 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-gray-800 dark:text-white">Обо мне</h2>
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            <motion.p variants={itemVariants} className="text-lg mb-6 text-gray-600 dark:text-gray-300">
              Привет! Я Евгений, fullstack разработчик с 4-летним опытом создания современных веб-приложений. Я
              специализируюсь на разработке высокопроизводительных и масштабируемых решений, используя передовые
            ...
            <motion.div variants={itemVariants} className="grid gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-white">Имя</h3>
                  <p className="text-gray-500 dark:text-gray-400">Евгений Селезнев</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-white">Опыт</h3>
                  <p className="text-gray-500 dark:text-gray-400">4 года коммерческой разработки</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-white">Специализация</h3>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 dark:text-white">Проекты</h3>
                  <p className="text-gray-500 dark:text-gray-400">Более 20 успешных проектов</p>
                </div>
              </div>
            </motion.div>
